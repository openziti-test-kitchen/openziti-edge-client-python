...
class EdgeRouterApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_current_identity_edge_routers_endpoint = _Endpoint(
            settings={
    ...
    def get_current_identity_edge_routers(
        self,
        **kwargs
    ):
        """Return this list of Edge Routers the identity has access to  # noqa: E501

        Lists the Edge Routers that the current identity has access to via policies. The data returned includes their address and online status   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_current_identity_edge_routers(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_current_identity_edge_routers_endpoint.call_with_http_info(**kwargs)
