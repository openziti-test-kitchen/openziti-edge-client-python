...
class PostureChecksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_posture_response_endpoint = _Endpoint(
            settings={
        ...
        self.create_posture_response_bulk_endpoint = _Endpoint(
            settings={
                'response_type': (PostureResponseEnvelope,),
                'auth': [
                    'ztSession'
    ...
    def create_posture_response(
        ...
        **kwargs
        ...
        Submits posture responses  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_posture_response(posture_response, async_req=True)
        >>> result = thread.get()

        Args:
            posture_response (PostureResponseCreate): A Posture Response
        ...
        kwargs['posture_response'] = \
            posture_response
        return self.create_posture_response_endpoint.call_with_http_info(**kwargs)

    def create_posture_response_bulk(
        self,
        posture_response,
        **kwargs
    ):
        ...
        >>> thread = api.create_posture_response_bulk(posture_response, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['posture_response'] = \
            posture_response
        return self.create_posture_response_bulk_endpoint.call_with_http_info(**kwargs)
