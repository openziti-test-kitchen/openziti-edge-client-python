...
class CurrentApiSessionCertificateDetailAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, certificate, fingerprint, subject, valid_from, valid_to, *args, **kwargs):  # noqa: E501
        """CurrentApiSessionCertificateDetailAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, certificate, fingerprint, subject, valid_from, valid_to, *args, **kwargs):  # noqa: E501
        """CurrentApiSessionCertificateDetailAllOf - a model defined in OpenAPI
